            ...
            <div className={`mt-10 p-8 border space-y-8 animate-fadeIn ${innerBg} ${isDarkMode ? 'border-stone-800' : 'border-stone-100'}`}>
               ...
               <div className="grid grid-cols-2 gap-8">
                  <div>
                    ...
                    <input placeholder="ММ / РР" className={`w-full py-3 text-sm focus:outline-none bg-transparent border-b ${isDarkMode ? 'border-stone-800 text-stone-200 focus:border-stone-100' : 'border-stone-200 text-stone-800 focus:border-stone-900'}`} />
                  </div>
                  <div>
                    ...
                    <input placeholder="•••" type="password" className={`w-full py-3 text-sm focus:outline-none bg-transparent border-b ${isDarkMode ? 'border-stone-800 text-stone-200 focus:border-stone-100' : 'border-stone-200 text-stone-800 focus:border-stone-900'}`} />
                  </div>
               </div>
            </div>
          )}
