      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className={`${cardBg} p-12 border shadow-2xl space-y-8 transition-colors duration-700`}>
          <div className="space-y-2">
            <h3 className={`text-[10px] font-black uppercase tracking-[0.4em] mb-4 ${isDarkMode ? 'text-stone-600' : 'text-stone-400'}`}>ячс</h3>
            <p className={`text-xl font-serif-gothic italic ${isDarkMode ? 'text-stone-200' : 'text-stone-900'}`}>ячс</p>
            <p className={`${textSecondary} text-sm`}>ячс</p>
          </div>
          ...
          <div className={`space-y-2 pt-8 border-t ${isDarkMode ? 'border-stone-800' : 'border-stone-100'}`}>
            ...
            <div className={`space-y-1 text-sm ${textSecondary}`}>
              <p className="flex justify-between"><span>ячс</span> <span className={isDarkMode ? 'text-stone-200' : 'text-stone-900'}>ячс</span></p>
              <p className="flex justify-between"><span>ячс</span> <span className={isDarkMode ? 'text-stone-200' : 'text-stone-900'}>ячс</span></p>
              <p className={`flex justify-between italic ${isDarkMode ? 'text-stone-700' : 'text-stone-300'}`}><span>ячс</span> <span>ячс</span></p>
            </div>
          </div>
        </div>
        ...
        <div className={`${cardBg} p-12 border shadow-2xl space-y-8 transition-colors duration-700`}>
          <div className="space-y-2">
            ...
            <p className={`text-xl font-serif-gothic italic underline underline-offset-8 decoration-stone-800 ${isDarkMode ? 'text-stone-200' : 'text-stone-900'}`}>ячс</p>
            <p className={`${textMuted} text-[9px] uppercase tracking-widest mt-2`}>ячс</p>
          </div>
